...
HD_PWD='/net/e/fpouget001/SE/EN325-Advanced-digital-design/Partie-5/JPEG.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RGB2YUV.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RGB2YUV.tcl -notrace
